...
## Features
- Fetches live news by category and country.
- Pagination with Previous/Next buttons.
- Loading spinner and responsive design.
...
## Usage
- Browse headlines; filter by category/country via props (e.g., <News category="sports" country="us" />).
